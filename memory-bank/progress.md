...
## Completed
- **UX Step 1:** Kill dark patterns (fake toasts, countdown, scarcity, fake stats)
- **UX Step 2:** Restructure IA (14 scroll sections → organized)
- **UX Step 3:** Trust-first hero (one CTA, passport preview, clear value prop)
...
- **Tech Step 7:** data.js — all arrays as ES module exports (split: data-personas.js + data-sections.js)
...
- **Tech Step 9:** nav.js — mobile menu, scroll tracking, SPA routing, keyboard shortcuts

## Next
- **Tech Step 10:** (pending)
